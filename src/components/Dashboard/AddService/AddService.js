...
const AddService = () => {
  ...
  const onSubmit = (data) => {
    ...
    const url = `https://obscure-peak-91522.herokuapp.com/addService`;
    fetch(url, {
      method: 'POST',
      headers: {
  ...
  const handleImageUpload = (event) => {
    ...
    imageData.set('key', '94211d8dcd2ea1b5c4f9d24c2297ac73');
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='row'>
            ...
            <div className='col-md-3'>
              ...
              <br />
              {errors.image && (
                <span style={{ color: 'red' }}>Photo/Icon is required</span>
              )}{' '}
              <br />
            </div>
          </div>
